 ...
 * com.chicos.interfaces.tests.associate.BuildAssociateKey \
 * -a /user/mapr/tables/chicos/associate.db \
 * 2>&1 | tee log/associate-key-associate-table$(date +%Y%m%d_%H%M%S).log
 */
